...
import BarChartOutlineOutlinedIcon from "@mui/icons-material/BarChartOutlined";
import PieCharOutlineOutlinedIcon from "@mui/icons-material/PieChartOutlineOutlined";
                ...
                <ProSidebar collapsed={isCollapsed}>
                    <Menu iconShape="square">
                        ...
                        <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                            ...
                            title="Bar Chart"
                            to="/bar"
                            icon={<BarChartOutlineOutlinedIcon/>}
                            selected={selected}
                            setSelected={setSelected}
                            />
                            <Item
                            title="Pie Chart"
                            to="/Pie"
                            icon={<PieCharOutlineOutlinedIcon/>}
                            selected={selected}
                            setSelected={setSelected}
                            />
                            <Item
